...
class MapTest {
    ...
    void adjacencyTest() {
        ...
        assertEquals(l.getAdjacentAt(SW), m.getLocation(2,0),"The location (2,0) is SW of (1,1)");
        ...
        assertEquals(l.getAdjacentAt(NW), m.getLocation(0,1), "The location (0,1) is NW of (1,2)");
        assertEquals(l.getAdjacentAt(N), m.getLocation(0,2),"The location (0,2) is N of (1,2)");
        assertEquals(l.getAdjacentAt(NE), null, "There is no location NE of (1,2)");
        assertEquals(l.getAdjacentAt(W), m.getLocation(1,1),"The location (1,1) is W of (1,2)");
        assertEquals(l.getAdjacentAt(E), null, "There is no location E of (1,2)");
        assertEquals(l.getAdjacentAt(SW), m.getLocation(2,1),"The location (2,1) is SW of (1,2)");
        assertEquals(l.getAdjacentAt(S), m.getLocation(2,2),"The location (2,2) is S of (1,2)");
        ...
        assertEquals(l.getAdjacentAt(N), m.getLocation(1,0),"The location (1,0) is N of (2,0)");
        assertEquals(l.getAdjacentAt(NE), m.getLocation(1,1),"The location (1,1) is NE of (2,0)");
        assertEquals(l.getAdjacentAt(W),null, "There is no location W of (2,0)");
        assertEquals(l.getAdjacentAt(E), m.getLocation(2,1),"The location (2,1) is E of (2,0)");
        ...
        assertEquals(l.getAdjacentAt(NW), m.getLocation(1,0),"The location (1,0) is NW of (2,1)");
        assertEquals(l.getAdjacentAt(N), m.getLocation(1,1),"The location (1,1) is N of (2,1)");
        assertEquals(l.getAdjacentAt(NE), m.getLocation(1,2),"The location (1,2) is NE of (2,1)");
        assertEquals(l.getAdjacentAt(W), m.getLocation(2,0),"The location (2,0) is W of (2,1)");
        assertEquals(l.getAdjacentAt(E), m.getLocation(2,2),"The location (2,2) is E of (2,1)");
        ...
        assertEquals(l.getAdjacentAt(NW), m.getLocation(1,1),"The location (1,1) is NW of (2,2)");
        assertEquals(l.getAdjacentAt(N), m.getLocation(1,2),"The location (1,2) is N of (2,2)");
        assertEquals(l.getAdjacentAt(NE), null, "There is no location NE of (2,2)");
        assertEquals(l.getAdjacentAt(W), m.getLocation(2,1),"The location (2,1) is W of (2,2)");
